...
AtrL["Experimental"] = "Экспериментальные"
AtrL["experimental options saved"] = "экспериментальные настройки сохранены"
AtrL["Cache search results:"] = "Время жизни кеша:"
AtrL["Cache search results:"] = "Время жизни кеша:"
AtrL["How long to keep search results in memory before searching again"] = "Как долго хранить результаты поиска в памяти перед повторным поиском"
AtrL["No caching"] = "Без кеширования"
AtrL["10 seconds"] = "10 секунд"
AtrL["30 seconds"] = "30 секунд"
AtrL["1 minute"] = "1 минута"
AtrL["5 minutes"] = "5 минут"
AtrL["30 minutes"] = "30 минут"
AtrL["1 hour"] = "1 час"
AtrL["Always (until reload)"] = "Всегда (до перезагрузки)"

-- Cache age display
AtrL["Data: just updated"] = "Данные: только что обновлены"
AtrL["Data: %d seconds ago"] = "Данные: %d сек. назад"
AtrL["Data: %d minutes ago"] = "Данные: %d мин. назад"
AtrL["Data: %d hours ago"] = "Данные: %d ч. назад"
AtrL["Refreshing data..."] = "Обновление данных..."
AtrL["Refresh"] = "Обновить"
AtrL["Current Bid"] = "Текущая ставка"
AtrL["no bids"] = "нет ставок"
AtrL["n/a"] = "н/д"
AtrL["Ставка"] = "Ставка"
AtrL["Выкуп"] = "Выкуп"
AtrL["Количество"] = "Количество"
AtrL["Время"] = "Время"
AtrL["Продавец"] = "Продавец"
