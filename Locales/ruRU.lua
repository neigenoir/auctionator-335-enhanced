...
-- Cache age display
AtrL["Data: just updated"] = "Обновлено: только что"
AtrL["Data: %d seconds ago"] = "Обновлено: %d сек. назад"
AtrL["Data: %d minutes ago"] = "Обновлено: %d мин. назад"
AtrL["Data: %d hours ago"] = "Обновлено: %d ч. назад"
